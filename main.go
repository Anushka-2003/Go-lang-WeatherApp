...
func main(){
	...
	// Api part
	// arr []string:= {"Lucknow", "Mumbai", "Noida", "Kashmir"};
	res, err := http.Get("http://api.openweathermap.org/data/2.5/weather?q="+ "noida" +"&APPID=ba783a3359f43d3e36b30e54b913f134")
	if err != nil{
		fmt.Println(err)
	}
	...
	img := canvas.NewImageFromFile("images.jfif")
	img.FillMode = canvas.ImageFillOriginal

	combo := widget.NewSelect([]string{"Lucknow", "Mumbai", "Noida", "Kashmir"}, func(value string) {
